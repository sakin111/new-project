...
const BlackMarket = () => {
    return (
        <div className="flex flex-col justify-center items-center text-center bg-gray-900 text-white py-16 px-6 rounded-lg shadow-lg min-h-screen max-w-7xl mx-auto">
      <h2 className="text-3xl font-bold mb-4">Black Market Deals</h2>
