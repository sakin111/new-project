...
const FridayNight = () => {
    return (
        <div className="flex flex-col justify-center items-center text-center bg-gray-900 text-white min-h-screen py-16 px-6 rounded-lg shadow-lg max-w-7xl mx-auto">
        <h2 className="text-3xl font-bold mb-4">Friday Night Sale</h2>
